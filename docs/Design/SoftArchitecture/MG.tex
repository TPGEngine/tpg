...
\begin{description}
  ...
  \item[\refstepcounter{acnum} \actheacnum \label{acVerify1}:] Extensive testing and checks for newly published code.
...
The capstone project's timeline will correspond to the main goals that have been outlined, as seen in Table \ref{tab:my_label}. The work has been split between the different modules with respective deadlines so that the team can work on separate modules concurrently. The deadlines have been set to help track progress and establish expectations. 
