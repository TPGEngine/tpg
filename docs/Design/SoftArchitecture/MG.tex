...
\midrule
FR-1 & \mref{mMuJoCo}, \mref{mFramework}\\
FR-2 & \mref{mVisualization},\\
FR-3 & \mref{mLogging}, \mref{mFramework}\\
FR-4 & \mref{mLogging}, \mref{mFramework}\\
FR-5 & \mref{mLogging}, \mref{mFramework}, \mref{mControl}\\
FR-6 & \mref{mClassicControl}, \mref{mMuJoCo}, \mref{mVisualization}, \mref{mLogging}, \mref{mExperiment}, \mref{mFramework}\\
FR-7 & \mref{mLogging}, \mref{mFramework}\\
...
\begin{table}[H]
  ...
  \\
  AC2
  & Visualization & \mref{mVisualization}
  \\
  AC3
  & Logging & \mref{mLogging}
  \\
  AC4
  & Framework & \mref{mFramework} 
  \\
  AC5
  & Classic Control, TPG Experiment, Framework  & \mref{mClassicControl}, \mref{mExperiment}, \mref{mFramework} 
  \\
  AC6
  & TPG Experiment, Framework & \mref{mExperiment}, \mref{mFramework} 
  \\
  AC7
  & Framework & \mref{mFramework} 
  \\
