...
\midrule
10/9/2024 & 0.0 & Intial draft of SRS document.\\
3/11/2025 & 0.1 & Modified functional requirements based on feedback\\
3/29/2025 & 0.2 & Modified Purpose of Project based on peer review feedback\\
3/30/2025 & 0.3 & Revised non-functional requirements\\
3/31/2025 & 0.4 & Added external links from TA Feedback\\
4/02/2025 & 1 & Revision 1\\
% Date 2 & 1.1 & Notes\\
\bottomrule
\end{tabularx}
...
\section{Traceability Matrix}
  \begin{longtable}{|c|p{6cm}|p{5cm}|p{4cm}|}
    ...
    \hline
    % Usability and Humanity Requirements (UH)
    ...
    \hline
    % Operational and Environmental Requirements (OE)
    ...
    \hline
    % Maintainability and Support Requirements (MS)
    ...
    \hline
    % User Documentation Requirements (USD)
