...
The goal of this project is to redirect the development of TPG to support standard software engineering principles such as continuous integration, test cases, and generative documentation and to design and evaluate an agent-environment interface between TPG and the quadruped robot modeled in MuJoCo.
