...
\begin{longtable}{| p{0.2\textwidth} | p{0.2\textwidth} | p{0.3\textwidth} | p{0.1\textwidth} |}
    ...
    \hline
    \endfoot
    TA Feedback & Enough to Build & \textbf{Did Not Fix}: Did not include additional sketchecs or examples, as current level of detail seemed sufficient for our project scope. & \href{https://github.com/TPGEngine/tpg/issues/347}{\#347} \\
    \hline
    Peer Review & Confusion & Clarified confusing sections in the module specification interface. & \href{https://github.com/TPGEngine/tpg/issues/245}{\#245} \\
    \hline
    ...
    \hline
    Peer Review & Incorrect "Uses" & Corrected "Uses" subsections in the module specification interface for modules. & \href{https://github.com/TPGEngine/tpg/issues/244}{\#244} \\
    \hline
\end{longtable}
