...
%% Bibliography style
\RequirePackage[
  datamodel=assets/acmdatamodel,
  style=assets/acmnumeric,
  ]{biblatex}

%% Declare bibliography sources (one \addbibresource command per source)
\addbibresource{assets/software.bib}
\addbibresource{assets/sample-base.bib}
...
\title{Enhancing Multi-Task Reinforcement Learning for MuJoCo Tasks with Dynamic Memory in Tangled Program Graphs}
