...
std::unordered_map<string, std::any> createDefaultParams() {
   ...
   params["stateful"] = std::any_cast<int>(1);
   params["observation_buff_size"] = std::any_cast<int>(1);
   params["max_initial_prog_size"] = std::any_cast<int>(10);
   params["p_memory_mu_const"] = std::any_cast<int>(0.5);
   params["n_memories"] = std::any_cast<int>(8);
   params["memory_size"] = std::any_cast<int>(8);
   params["continuous_output"] = std::any_cast<int>(1);
   params["n_discrete_action"] = std::any_cast<int>(1);
   return params;
}
